...
Version  : 19
Release  : 19
URL      : https://github.com/clearlinux/clr-network-troubleshooter/archive/v19/clr-network-troubleshooter-19.tar.gz
Source0  : https://github.com/clearlinux/clr-network-troubleshooter/archive/v19/clr-network-troubleshooter-19.tar.gz
...
%prep
%setup -q -n clr-network-troubleshooter-19
cd %{_builddir}/clr-network-troubleshooter-19
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664302746
