...
Version  : 9
Release  : 10
URL      : https://github.com/clearlinux/clr-network-troubleshooter/archive/v9/clr-network-troubleshooter-9.tar.gz
Source0  : https://github.com/clearlinux/clr-network-troubleshooter/archive/v9/clr-network-troubleshooter-9.tar.gz
...
%prep
%setup -q -n clr-network-troubleshooter-9
cd %{_builddir}/clr-network-troubleshooter-9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601325285
...
cp %{_builddir}/clr-network-troubleshooter-9/COPYING %{buildroot}/usr/share/package-licenses/clr-network-troubleshooter/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
