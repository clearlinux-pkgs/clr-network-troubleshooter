...
Version  : 18
Release  : 18
URL      : https://github.com/clearlinux/clr-network-troubleshooter/archive/v18/clr-network-troubleshooter-18.tar.gz
Source0  : https://github.com/clearlinux/clr-network-troubleshooter/archive/v18/clr-network-troubleshooter-18.tar.gz
...
%prep
%setup -q -n clr-network-troubleshooter-18
cd %{_builddir}/clr-network-troubleshooter-18
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663857185
