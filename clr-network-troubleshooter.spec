...
Version  : 12
Release  : 12
URL      : https://github.com/clearlinux/clr-network-troubleshooter/archive/v12/clr-network-troubleshooter-12.tar.gz
Source0  : https://github.com/clearlinux/clr-network-troubleshooter/archive/v12/clr-network-troubleshooter-12.tar.gz
...
%prep
%setup -q -n clr-network-troubleshooter-12
cd %{_builddir}/clr-network-troubleshooter-12
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601587103
...
cp %{_builddir}/clr-network-troubleshooter-12/COPYING %{buildroot}/usr/share/package-licenses/clr-network-troubleshooter/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
