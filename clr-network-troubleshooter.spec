...
Version  : 8
Release  : 9
URL      : https://github.com/clearlinux/clr-network-troubleshooter/archive/v8/clr-network-troubleshooter-8.tar.gz
Source0  : https://github.com/clearlinux/clr-network-troubleshooter/archive/v8/clr-network-troubleshooter-8.tar.gz
...
%prep
%setup -q -n clr-network-troubleshooter-8
cd %{_builddir}/clr-network-troubleshooter-8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601056632
...
cp %{_builddir}/clr-network-troubleshooter-8/COPYING %{buildroot}/usr/share/package-licenses/clr-network-troubleshooter/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
