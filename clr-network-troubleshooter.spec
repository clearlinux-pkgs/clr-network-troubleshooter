...
Version  : 14
Release  : 14
URL      : https://github.com/clearlinux/clr-network-troubleshooter/archive/v14/clr-network-troubleshooter-14.tar.gz
Source0  : https://github.com/clearlinux/clr-network-troubleshooter/archive/v14/clr-network-troubleshooter-14.tar.gz
...
%prep
%setup -q -n clr-network-troubleshooter-14
cd %{_builddir}/clr-network-troubleshooter-14
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622584540
...
cp %{_builddir}/clr-network-troubleshooter-14/COPYING %{buildroot}/usr/share/package-licenses/clr-network-troubleshooter/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
