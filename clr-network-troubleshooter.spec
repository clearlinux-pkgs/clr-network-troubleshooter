...
Version  : 1
Release  : 1
URL      : https://github.com/clearlinux/clr-network-troubleshooter/archive/v1.tar.gz
Source0  : https://github.com/clearlinux/clr-network-troubleshooter/archive/v1.tar.gz
...
%prep
%setup -q -n clr-network-troubleshooter-1
...
export LANG=C
export SOURCE_DATE_EPOCH=1553271974
