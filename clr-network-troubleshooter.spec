...
Version  : 2
Release  : 2
URL      : https://github.com/clearlinux/clr-network-troubleshooter/archive/v2.tar.gz
Source0  : https://github.com/clearlinux/clr-network-troubleshooter/archive/v2.tar.gz
...
%prep
%setup -q -n clr-network-troubleshooter-2
...
export LANG=C
export SOURCE_DATE_EPOCH=1556137603
