...
Version  : 17
Release  : 17
URL      : https://github.com/clearlinux/clr-network-troubleshooter/archive/v17/clr-network-troubleshooter-17.tar.gz
Source0  : https://github.com/clearlinux/clr-network-troubleshooter/archive/v17/clr-network-troubleshooter-17.tar.gz
...
%prep
%setup -q -n clr-network-troubleshooter-17
cd %{_builddir}/clr-network-troubleshooter-17
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663714421
