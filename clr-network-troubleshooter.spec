...
Version  : 16
Release  : 16
URL      : https://github.com/clearlinux/clr-network-troubleshooter/archive/v16/clr-network-troubleshooter-16.tar.gz
Source0  : https://github.com/clearlinux/clr-network-troubleshooter/archive/v16/clr-network-troubleshooter-16.tar.gz
...
%prep
%setup -q -n clr-network-troubleshooter-16
cd %{_builddir}/clr-network-troubleshooter-16
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663350941
