...
Version  : 4
Release  : 4
URL      : https://github.com/clearlinux/clr-network-troubleshooter/archive/v4.tar.gz
Source0  : https://github.com/clearlinux/clr-network-troubleshooter/archive/v4.tar.gz
...
%prep
%setup -q -n clr-network-troubleshooter-4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567182021
